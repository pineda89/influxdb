...
You should also read our [coding guide](https://github.com/pineda89/influxdb/blob/master/CODING_GUIDELINES.md), to understand better how to write code for InfluxDB.
...
```bash
    ...
    go get github.com/pineda89/influxdb
```
...
-----
InfluxDB uses CircleCI for continuous integration testing. CircleCI executes [test.sh](https://github.com/pineda89/influxdb/blob/master/test.sh), so you may do the same on your local development environment before creating a pull request.
